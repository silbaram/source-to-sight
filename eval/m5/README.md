...
프로젝트 전체의 책임 구역과 대표 기능을 살펴보고 **지도 → 동작 설명 → 규칙과 이유**로 이동하는 결과입니다. 개발된 코드와 함께 확인할 수 있도록 코드리뷰 수정을 반영한 `build/eval/m5-review-final/`의 최종 지도를 보관했습니다.
...
연결된 동작 12개 모두에서 **프로젝트 지도**로 돌아올 수 있습니다. 상세 설명을 읽는 동안 창 크기를 바꾸거나 휴대폰을 회전했다면 복귀 시 선택한 노드를 현재 화면 안에 다시 보여 줍니다.
...
[코드리뷰 수정 검증](../reports/m5-review-fixes.md) · [설명 내용 정리](../reports/m5-content-fix.md) · [M5 최초 검증](../reports/m5-verification.md) · [소스 읽기 기록](discovery.md) · [보존한 평가 결과](../runs/2026-09-07-m5-content-fix.md) · [프로젝트 지도 사용 안내](../../docs/project-maps.md)
